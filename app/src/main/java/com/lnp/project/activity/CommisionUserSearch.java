...
import com.lnp.project.adapter.CommisionUserSearchAdapter;
...
public class CommisionUserSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_commision_user_search);
        mEditText = findViewById(R.id.commision_user_search_search);
        searchButton = findViewById(R.id.commision_user_search_button);

        mRecyclerView = findViewById(R.id.commision_user_search_recycler);
        setTitle("Search Retailer");
        ...
        new Thread(() -> {
            try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD)) {
                String sql = "\n" +
                        ...
                        "lu.idlnp_user_id = lui.lnp_user_information_user_id where lu.lnp_user_admin = 2";
                ...
                runOnUiThread(() -> {
                    CommisionUserSearchAdapter adapter = new CommisionUserSearchAdapter(CommisionUserSearch.this, myListData);
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String searchSql = "select * from lnp.lnp_user as lu inner join lnp.lnp_user_information as lui on \n" +
                        "lu.idlnp_user_id = lui.lnp_user_information_user_id where lu.lnp_user_admin = 2 and";
                ...
                new Thread(() -> {
                    try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD)) {
                        ...
                        runOnUiThread(() -> {
                            UserSearchAdapter adapter = new UserSearchAdapter(CommisionUserSearch.this, myListData);
                            mRecyclerView.setHasFixedSize(true);
                            mRecyclerView.setLayoutManager(new LinearLayoutManager(CommisionUserSearch.this));
                            mRecyclerView.setAdapter(adapter);
                        });
                    } catch (Exception e) {
                        Log.e("InfoAsyncTask", "Error reading school information", e);
