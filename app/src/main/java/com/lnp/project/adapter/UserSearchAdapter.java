...
public class UserSearchAdapter extends RecyclerView.Adapter<UserSearchAdapter.ViewHolder>{
    ...
    public UserSearchAdapter(Context context, List<UserNameAndIdDto> listdata) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        UserSearchAdapter.ViewHolder viewHolder = new UserSearchAdapter.ViewHolder(listItem);
        return viewHolder;
    }
